...
class GetEmoji:
    ...
    @classmethod
    def tier_by_bot(cls, skin_uuid: str, bot: ValoBot) -> discord.Emoji:
    ...
    def point_by_bot(point: str, bot: ValoBot) -> discord.Emoji:
...
class GetFormat:
    def offer_format(data: Dict) -> Dict:
        ...
        for uuid in offer_list:
            ...
            name, icon = skin['names'], skin['icon']
    ...
    def __get_item_battlepass(type: str, uuid: str, response: Dict) -> Dict[str, Any]:
        ...
        if type == 'Currency':
            data = JSON.read('cache')
            name = data['currencies'][uuid]['names']
            ...
            data = JSON.read('cache')
            name = data['playercards'][uuid]['names']
    ...
    def __get_contracts_by_season_id(contracts: Dict, data_contracts: Dict, season_id: str) -> Dict[str, Any]:
        ...
        if contracts_uuid:
            ...
            ACT = data_contracts['contracts'][contracts_uuid[0]]['names']
