...
class Auth:
    ...
    async def temp_auth(self, username: str, password: str) -> Optional[Dict[str, Any]]:
        ...
        if authenticate['auth'] == 'response':
            ...
            user_data = {'puuid': puuid, 'headers': headers, 'player_name': player_name}
            return user_data

# async def login(username, password):
#     newAuth = Auth()
#     print(await newAuth.authenticate(username, password))
    
# asyncio.run(login('woochangroh','richard9993!'))