...
class GetEmbed:
    def __giorgio_embed(skin: Dict, bot: ValoBot) -> discord.Embed:
    ...
    @classmethod
    def store(cls, player: str, offer: Dict, bot: ValoBot) -> List[discord.Embed]:
        """Embed Store"""
        
        store_esponse = "**{username}**의 일일상점 | {duration} 종료"
    ...
    def point(player: str, wallet: Dict, response: Dict, bot: ValoBot) -> discord.Embed:
        """Embed Point"""
        ...
        rad = point[rad_uuid]['names']['ko']
        vp = point[vp_uuid]['names']['ko']
        if vp == 'VP':
            vp = 'Valorant Points'
    ...
    def __nightmarket_embed(skins: Dict, bot: ValoBot) -> discord.Embed:
    ...
    @classmethod
    def nightmarket(cls, player: str, offer: Dict, bot: ValoBot, response: Dict) -> discord.Embed:
        """Embed Night Market"""
    ...
    @classmethod
    def notify_all_send(cls, player: str, offer: Dict, response: Dict, bot: ValoBot) -> discord.Embed:
