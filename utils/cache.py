...
def fetch_skin() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/weapons/skins?language=ko-KR')
...
def fetch_mission() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/missions?language=ko-KR')
    if resp.status_code == 200:
        json = {}
...
def fetch_playercard() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/playercards?language=ko-KR')
    if resp.status_code == 200:
        payload = {}
        # json['version'] = get_valorant_version()
...
def fetch_titles() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/playertitles?language=ko-KR')
    if resp.status_code == 200:
        payload = {}
...
def fetch_spray() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/sprays?language=ko-KR')
    if resp.status_code == 200:
        payload = {}
...
def fetch_bundles() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/bundles?language=ko-KR')
    if resp.status_code == 200:
        bundles = {}
...
def fetch_contracts() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/contracts?language=ko-KR')
...
def fetch_currencies() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/currencies?language=ko-KR')
    if resp.status_code == 200:
        payload = {}
...
def fetch_buddies() -> None:
    ...
    resp = requests.get(f'https://valorant-api.com/v1/buddies?language=ko-KR')
    if resp.status_code == 200:
        payload = {}
...
#     resp = session.get('https://valorant-api.com/v1/weapons/skinchromas?language=ko-KR')
#     if resp.status_code == 200:
#         json = {}
#         # json['version'] = get_valorant_version()
